...
vv=$(pwd)
# Using Recorderjs by: https://github.com/Jokergazaa
trap 'printf "\n";stop' 2
...
░▄█░█▀▀█▀▀▀█▀▀▀█▀▀█░█▄░
" |lolcat
printf "\e[1;77m v7.1 coded by A-H-M\e[0m \n"
printf "Re-Designed By: AHM7D Sy \n" |lolcat
printf " Telegram: https://t.me/jokerplstaeen\n" |lolcat
